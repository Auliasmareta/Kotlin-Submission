 ...
 */
fun myProfile() {
    val firstName: String = "Aulia"
    val lastName: String = "Suci Mareta"
    val age: Int = 23
...
fun main() {
    ...
    groupDetail(1, groupMembers, "Afternoon")
}
 ...
 */
fun myGroup(): String {
    val groupMembers = listOf("Aulia", "Annisa", "Dian", "Delima", "Kanro") // Daftar Nama Anggota Grup(Aulia, Annisa, Dian, Delima, Kanro)
...
fun main() {
    ...
    fun main() {
        val groupNumber = 1
        val members = listOf("Anggota Aulia", "Anggota Annisa", "Anggota Dian", "Anggota Delima", "Anggota Kanro")
